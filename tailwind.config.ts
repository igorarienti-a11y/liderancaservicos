  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsla(43, 95%, 55%, 0.4)" },
          "50%": { boxShadow: "0 0 40px hsla(43, 95%, 55%, 0.6)" },
        },
      },
      animation: {
      ...
      backgroundImage: {
        "hero-gradient": "linear-gradient(135deg, hsl(var(--lideranca-navy)) 0%, hsl(var(--lideranca-navy-dark)) 100%)",
        "cta-gradient": "linear-gradient(135deg, hsl(var(--lideranca-yellow)) 0%, hsl(43 100% 45%) 100%)",
      },
    },
  },
